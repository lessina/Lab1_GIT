...
namespace MicrosoftTranslatorSdk.HttpSamples
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AdmAuthentication admAuth = new AdmAuthentication("lessina_olga", "OwmHL02dvVatjeQOCCA6IvXHZh4iBJYYwsvJc2ua8yo=");
            try
            {
        ...
        private static void DetectMethod(string authToken)
        {
         ...
         //   httpWebRequest.Headers.Add("Authorization", "hello");//authToken);
